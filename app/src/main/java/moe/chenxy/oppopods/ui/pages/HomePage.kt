    ...
    BoxWithConstraints(modifier = Modifier.fillMaxWidth()) {
        if (maxWidth >= 600.dp) {
            Row(
                ...
                StatCard(title = "蓝牙状态", value = if (bluetoothEnabled) "已开" else "未开", modifier = Modifier.weight(1f).height(112.dp), onClick = onBluetoothStatusClick)
            ...
            Row(
                ...
                Column(
                    ...
                    StatCard(title = "蓝牙状态", value = if (bluetoothEnabled) "已开" else "未开", modifier = Modifier.weight(1f), onClick = onBluetoothStatusClick)
